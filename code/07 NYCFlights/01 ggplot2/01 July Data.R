...
# Needed  that we order the days (useful for ggplot calls)
...
ggplot(data_m,aes(x=DayOfWeek))+geom_bar()
ggplot(data_m,aes(x=HourOfDay))+geom_bar()
ggplot(data_m,aes(x=HourOfDay,fill=DayOfWeek))+geom_bar()
